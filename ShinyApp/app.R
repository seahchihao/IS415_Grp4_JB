    ...
    fluidRow(
        box(
            ...
            tags$ul(
                ...
                tags$li("Understand factors influencing housing prices through regression models.")
            ),
...
proximity_mapping_tab <- tabItem(
    ...
    fluidRow(
        box(
            ...
            solidHeader = TRUE,
            width = 12,
            tmapOutput("amenity_map", height = tall_map)
        )
    ),
    fluidRow(
        box(
...
ui <- dashboardPage(
    ...
    dashboardSidebar(
        sidebarMenu(
            ...
            menuItem("Exploratory Data Analysis", 
                    ...
                    menuSubItem("Property (Hexbin)", tabName = "hexagonal_grid", icon = icon("chart-area"))
            ),
            menuItem("Hot/Cold Spot Analysis", tabName = "hot_cold_analysis", icon = icon("thermometer-half"))
        )
    ),
    ...
    dashboardBody(
        ...
        tabItems(
            ...
            tabItem(tabName = "hot_cold_analysis", h2("Hot/Cold Spot Analysis Content"))
        )
    )
)
